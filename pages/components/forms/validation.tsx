              ...
              <form className="ti-validation">
                <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <DatePicker className="ti-form-input" showIcon selected={startDate} onChange={(date) => setStartDate(date as Date)} />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="my-5 flex items-center">
                  <input className="form-check-input" type="checkbox" id="invalidCheck1" value="" required />
                  <label htmlFor="hs-checkbox-group-1" className="!inline text-sm text-gray-500 ms-3 dark:text-[#8c9097] dark:text-white/50">I agree with the <Link href="/components/pages/terms&conditions/" className="text-primary hover:underline ms-1">terms and conditions</Link></label>
                </div>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <form className="ti-custom-validation" noValidate>
                ...
                <div className="my-5 flex items-center">
                  <input className="form-check-input" type="checkbox" id="invalidCheck2" value="" required />
                  <span className="checkboxError text-red-500 text-xs hidden">error</span>
                  <label htmlFor="hs-checkbox-group-12" className="!inline text-sm text-gray-500 ms-3 dark:text-[#8c9097] dark:text-white/50">I agree with the <Link href="/components/pages/terms&conditions/" className="text-primary hover:underline">terms and conditions</Link></label>
                </div>
