import {DisabledGroupData, Multipleselectdata, Multipleselectdata1, Zerodata, defaultselect, multiDropdownSelect, singleselect } from '@/shared/data/forms/form-elements/formselectdata';
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            ...
            <div className="box-body">
              <Select classNamePrefix='Select2' className="ti-form-select rounded-sm !p-0" placeholder="Label Six"  options={Zerodata} />
            </div>
          </div>
        </div>
        <div className="col-span-12 lg:col-span-6">
