                ...
                <div className="xl:col-span-9 col-span-12">
                    <div className="box">
                        ...
                        <div className="box-body sm:flex justify-around">
                            <div>
                                <div>
                                    <button className='theme-container active ti-btn ti-btn-primary-full' onClick={() => setShowColorPicker(showColorPicker => !showColorPicker)}>{showColorPicker ? "Close Picker" : "Pick Color"}</button>
