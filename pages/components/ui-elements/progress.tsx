...
const Progress = () => {
    ...
    <div className="progress mb-4 !rounded-full" aria-valuenow={Number(idx.valuenow)} aria-valuemin={0} aria-valuemax={100} key={Math.random()} role="progressbar">
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Different Colored Progress" code={progress2}>
                        {colorprogress.map((idx) => (
                            <div className="progress mb-4" aria-valuenow={Number(idx.valuenow)} role="progressbar" aria-valuemin={0} key={Math.random()}
                                aria-valuemax={100}>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Stripped Progress" code={progress3}>
                        {stripped.map((idx) => (
                            <div className="progress mb-4" aria-valuenow={10} aria-valuemin={0} role="progressbar" aria-valuemax={100} key={Math.random()}>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Progress With Labels" code={progress5}>
                        {lables.map((idx) => ( 
                            <div className="progress mb-4" key={Math.random()} role="progressbar"
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Multiple Bars With Sizes" code={progress6}>
                        <div className="progress-stacked progress-xs mb-4 flex">
                            <div className="progress-bar w-[5%]" aria-valuenow={5} role="progressbar" aria-valuemin={0} aria-valuemax={100}></div>
                        ...
                        <div className="progress-stacked mb-4 flex">
                            <div className="progress-bar !bg-info w-[15%]" role="progressbar"
                                aria-valuenow={15} aria-valuemin={0} aria-valuemax={100}></div>
                            <div className="progress-bar !bg-success !rounded-none w-1/5" role="progressbar"
                                aria-valuenow={20} aria-valuemin={0} aria-valuemax={100}></div>
                            <div className="progress-bar !rounded-none w-1/4"  role="progressbar"
                                aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                        <div className="progress-stacked progress-lg mb-4 flex">
                            <div className="progress-bar !bg-purple w-1/5" role="progressbar"
                                aria-valuenow={20} aria-valuemin={0} aria-valuemax={100}></div>
                            <div className="progress-bar !bg-teal !rounded-none w-1/4" role="progressbar"
                                aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}></div>
                            <div className="progress-bar !bg-orange !rounded-none w-[30%]" role="progressbar"
                                aria-valuenow={30} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                        <div className="progress-stacked progress-xl mb-0 flex">
                            <div className="progress-bar !bg-success w-1/4" role="progressbar"
                                aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}></div>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Animated Stripped Progress" code={progress7}>
                        {animated.map((idx) => (
                            <div className="progress mb-4"  role="progressbar" aria-valuenow={Number(idx.valuenow)} aria-valuemin={0} aria-valuemax={100} key={Math.random()}>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Custom Animated Progress" code={progress9}>
                        {Gradient.map((idx) => (
                            <div className="progress mb-4 progress-animate" role="progressbar" aria-valuenow={Number(idx.valuenow)} aria-valuemin={0} aria-valuemax={100} key={Math.random()}>
                                <div className={`progress-bar bg-${idx.color}-gradient ${idx.width}`}></div>
                            </div>
                        ))}
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Custom Progress-4" code={progress13}>
                        {Custom.map((idx) => (
                            <div className={`progress progress-xl mb-4 progress-animate custom-progress-4 ${idx.color}`} role="progressbar" aria-valuenow={Number(idx.valuenow)} aria-valuemin={0} aria-valuemax={100} key={Math.random()}>
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Custom Progress-5" code={progress14}>
                        ...
                        <div className="progress-stacked progress-xl mb-[3rem] flex">
                            <div className="progress-bar w-1/2" role="progressbar"
                            ...
                            <div className="progress-bar !bg-danger !rounded-s-none !rounded-e-full w-2/5" role="progressbar"
