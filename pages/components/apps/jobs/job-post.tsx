                        ...
                        <div className="box-body">
                            <div className="grid grid-cols-12 sm:gap-6 mb-4">
                                ...
                                <div className="xl:col-span-6 col-span-12">
                                    ...
                                    <Select name="colors" options={jobpost1} className="ti-form-select !p-0 !rounded-s-none" placeholder="Development"
                    ...
                    <div className="box custom-box">
                        ...
                        <div className="box-body">
                            <div className="xl:col-span-12 col-span-12">
                                ...
                                <Select name="colors" options={jobpost10} className="ti-form-select !p-0 !rounded-s-none" placeholder="Obiligation Pvt.Ltd"
                                    menuPlacement='auto' classNamePrefix="Select2" />
                            </div>
                        </div>
                    </div>
